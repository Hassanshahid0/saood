...
class Sale_model extends CI_Model {
  ...
  public function getWaitersForThisCompanyForOutlet1($company_id,$table){
    ...
    {
      $this->db->select("tbl_holds_details.*,tbl_holds_details.id as sales_details_id");
     ...
     * @param int
     */
    public function getModifiersByHoldAndHoldsDetailsId($hold_id,$sales_details_id)
    {
      ...
      $this->db->where("tbl_holds_details_modifiers.sales_details_id", $sales_details_id);
    ...
    public function make_datatables($outlet_id)
{
    ...
    {
        return isset($_POST['draw']) ? (int)$_POST['draw'] : 0;
    }
    /**
