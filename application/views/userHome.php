...
$base_color = '#c4a574';
$base_color2 = '#c4a5741a';
$dashboard_chart_color = '#c4a57445';
?>
<!DOCTYPE html>
<html>
<meta charset="utf-8">
...
<!-- Google Font - DM Sans (Figma sidebar style) -->
...
<style>
/* Figma dark sidebar theme - golden accent */
...
background-color: rgba(196, 165, 116, 0.15);
}
...
.main-sidebar .menu-open .treeview-menu li:hover, .main-sidebar2 .menu-open .treeview-menu li:hover {
color: #d4b896;
...
.main-sidebar .sidebar-menu .treeview-menu li > a, .main-sidebar2 .sidebar-menu .treeview-menu li > a {
    font-weight: 500;
    font-size: 13.5px;
    letter-spacing: 0.2px;
}

.main-sidebar .menu-header-text, .main-sidebar2 .menu-header-text {
    font-weight: 700;
    font-size: 12px;
...
<span><?php echo lang('Panel'); ?> / <?php echo lang('pos'); ?></span>
</a>
...
<span><?php echo lang('customer'); ?></span>
</a>
<ul class="treeview-menu">
...
<?php if(str_rot13($language_manifesto)=="eriutoeri"):?>
...
<!-- ORDER CHANNELS - Combined Menu -->
<li class="treeview menu__cidirp_order_channels common_use">
<a href="javascript:void(0)">
<i data-feather="monitor"></i>
<span>Order Channels</span>
</a>
<ul class="treeview-menu">
<li data-access="all_setting-358" class="menu_assign_class" data-menu__cid="irp_2222">
<a class="child-menu" href="<?php echo base_url()?>setting/selfOrderEnableDisable">
<?php echo lang('sos_Self_Order_Setting'); ?>
</a>
</li>
<li data-access="all_setting-358" class="menu_assign_class" data-menu__cid="irp_222">
<a class="child-menu" href="<?php echo base_url()?>setting/onlineOrderEnableDisable">
<?php echo lang('sos_online_order_setting'); ?>
</a>
</li>
...
<?php echo lang('reservationSetting'); ?>
</a>
</li>
</ul>
</li>
...
<li data-access="view-118" class="menu_assign_class" data-menu__cid="8"><a class="child-menu" href="<?php echo base_url()?>Promotion/promotions">
<?php echo lang('List'); ?> <?php echo lang('promotion'); ?></a></li>
<li data-access="view-321" class="menu_assign_class" data-menu__cid="8"><a class="child-menu" href="<?php echo base_url()?>Short_message_service/smsService">
<?php echo lang('send_sms'); ?></a></li>
</ul>
</li>
...
<span><?php echo lang('Saas'); ?> / Billing</span>
</a>
<ul class="treeview-menu">
