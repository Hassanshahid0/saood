    ...
    <div class="box-wrapper">
            <div class="table-box">
                            ...
                            <div class="form-group">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td> 
                                        <a data-file_path="<?php echo base_url()?>images/<?php echo escape_output(isset($outlet_information->invoice_logo) && $outlet_information->invoice_logo?$outlet_information->invoice_logo:''); ?>"  data-id="1" class="new-btn h-40 show_preview" href="#"><i class="fa fa-eye"></i>&nbsp;<?php echo lang('show'); ?></a>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="col-sm-12 mb-2 col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <select tabindex="2" class="form-control select2" name="currency_position" id="currency_position">
                                    <option <?= isset($outlet_information) && $outlet_information->currency_position == "Before Amount" ? 'selected' : '' ?>  value="Before Amount"><?php echo lang('Before_Amount'); ?></option>
                                    <option <?= isset($outlet_information) && $outlet_information->currency_position == "After Amount" ? 'selected' : '' ?>  value="After Amount"><?php echo lang('After_Amount'); ?></option>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4 col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" autocomplete="off" type="number" name="number_of_maximum_users" id="number_of_maximum_users" class="form-control" placeholder="<?php echo lang('number_of_maximum_users'); ?>" value="<?php echo escape_output(isset($outlet_information->number_of_maximum_users) && $outlet_information->number_of_maximum_users?$outlet_information->number_of_maximum_users:0); ?>">
                            </div>
                       ...
                       <div class="col-sm-12 mb-2 col-md-4 col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" autocomplete="off" type="number" name="number_of_maximum_outlets" id="number_of_maximum_outlets" class="form-control" placeholder="<?php echo lang('number_of_maximum_outlets'); ?>" value="<?php echo escape_output(isset($outlet_information->number_of_maximum_outlets) && $outlet_information->number_of_maximum_outlets?$outlet_information->number_of_maximum_outlets:0); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" autocomplete="off" type="number" name="number_of_maximum_invoices" id="number_of_maximum_invoices" class="form-control" placeholder="<?php echo lang('number_of_maximum_invoices'); ?>" value="<?php echo escape_output(isset($outlet_information->number_of_maximum_invoices) && $outlet_information->number_of_maximum_invoices?$outlet_information->number_of_maximum_invoices:0); ?>">
                            </div>
                ...
                <div class="box-footer">
                    ...
                    <a class="btn bg-blue-btn" href="<?php echo base_url() ?>Service/companies">
