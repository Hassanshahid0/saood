<?php
    ...
    $paymentSetting = paymentSettingSaas();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<!--Stripe payment form-->
    <form method="POST" action="<?php echo base_url()?>payment-form-saas" id="stripe_form">
    ...
    <!--Paypal payment form-->
    <form method="POST" action="<?php echo base_url()?>payment-form-saas" id="paypal_form">
