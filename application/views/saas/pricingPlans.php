                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="ir_w_9"><?php echo lang('yearly_cost'); ?></th>
                                            <th class="ir_w_9"><?php echo lang('allow_users'); ?>(<?php echo lang('monthly'); ?>)</th>
                                            <th class="ir_w_9"><?php echo lang('allow_outlets'); ?>(<?php echo lang('monthly'); ?>)</th>
                                            <th class="ir_w_9"><?php echo lang('allow_invoices'); ?>(<?php echo lang('monthly'); ?>)</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn_group_wrap">
                                                    <a class="btn btn-warning" href="<?php echo base_url() ?>Service/addPricingPlan/<?php echo escape_output($this->custom->encrypt_decrypt($spns->id, 'encrypt')); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-original-title="<?php echo lang('edit'); ?>">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    <a class="delete btn btn-danger" href="<?php echo base_url() ?>Service/deletePricingPlan/<?php echo escape_output($this->custom->encrypt_decrypt($spns->id, 'encrypt')); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php echo lang('delete'); ?>">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn_group_wrap">
                                                    <a class="btn btn-warning" href="<?php echo base_url() ?>Service/addCustomerReview/<?php echo ($key);?>" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-original-title="<?php echo lang('edit'); ?>">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    <a class="delete btn btn-danger" href="<?php echo base_url() ?>Service/deleteCustomerReview/<?php echo ($key); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php echo lang('delete'); ?>">
                                                        <i class="fa-regular fa-trash-can"></i>
                                                    </a>
                                                </div>
                                            </td>
