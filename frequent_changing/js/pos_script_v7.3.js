                                    ...
                                    let is_first = Number($("#is_first").val());
                                      ...
                                      if(updated_qty){
                                        ...
                                        if (this_item.menu_note != "" && this_item.menu_note!=undefined  && this_item.menu_note!=null && this_item.menu_note!="undefined") {
                                            item_html+= `<br><span  style="padding-left: 30px;">`+note_txt+": "+this_item.menu_note+`</span>`;
                                        }
                                        item_html+=`</td>`;
      ...
      function print_kot_print(order_info,kot_print) {
          ...
          for (let key in order.items) {
              ...
              if(if_kot_print){
                  ...
                  if (this_item.menu_note != "" && this_item.menu_note!=undefined  && this_item.menu_note!=null && this_item.menu_note!="undefined") {
                      row_of_item+= `<br><span  style="padding-left: 30px;">`+note_txt+": "+this_item.menu_note+`</span>`;
                  }
                  row_of_item+=`</td>`;
